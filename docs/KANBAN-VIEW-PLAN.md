...
- [x] Tạo `kanban-view.tsx` với layout cơ bản
- [x] Group tasks theo property
- [x] Render columns với cards đơn giản

### Phase 2: Components

- [x] Tạo `KanbanColumn` với header + card list
- [x] Tạo `KanbanCard` tái sử dụng `PropertyCell`
- [x] Tạo `KanbanCardModal` cho full edit

### Phase 3: DnD

- [x] Setup DndContext cho Kanban
- [x] Implement drag card within column
- [x] Implement drag card across columns
- [ ] Integrate với reorder API
- [ ] Handle optimistic updates

### Phase 4: Features

- [x] Integrate với reorder API
- [x] Handle optimistic updates

### Phase 4: Features

- [x] Search/Filter integration
- [x] Sort trong từng column
- [x] Add card quick action
- [ ] Column aggregations
- [x] Empty column handling
